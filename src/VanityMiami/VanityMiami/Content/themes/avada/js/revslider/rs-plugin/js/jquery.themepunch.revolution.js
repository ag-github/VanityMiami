...
********************************/
		...
		********************************/
		...
		var createArrows = function(container,opt) {
						...
						container.append('<div style="'+hidden+'" class="tp-leftarrow '+starthidearrows+' tparrows '+arst+'"><div class="tp-arr-allwrapper"><div class="tp-arr-iwrapper"><div class="tp-arr-imgholder"></div><div class="tp-arr-imgholder2"></div><div class="tp-arr-titleholder"></div><div class="tp-arr-subtitleholder"></div></div></div></div>');
						container.append('<div style="'+hidden+'" class="tp-rightarrow '+starthidearrows+' tparrows '+arst+'"><div class="tp-arr-allwrapper"><div class="tp-arr-iwrapper"><div class="tp-arr-imgholder"></div><div class="tp-arr-imgholder2"></div><div class="tp-arr-titleholder"></div><div class="tp-arr-subtitleholder"></div></div></div></div>');

						// 	THE LEFT / RIGHT BUTTON CLICK !	 //
						container.find('.tp-rightarrow').click(function() {
						...
						container.find('.tp-leftarrow').click(function() {
							if (opt.transition==0) {
									opt.next = opt.next-1;
