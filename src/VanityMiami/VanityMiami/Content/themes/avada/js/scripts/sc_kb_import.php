...
class La_Scripts_OldSCKbImport extends Gpf_Module implements Gpf_Controller{
    ...
    public function execute() {
        ...
        if($this->checkIfAdminIsLogin()) {
            $importLaTask = new La_Import_ImportOldSupportCenterKnowledgebase();
...
Gpf_Module::run(new La_Scripts_OldSCKbImport());
?>
